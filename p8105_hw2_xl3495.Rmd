...
proportion_entrance = format(proportion_entrance, nsmall = 2)
```

In total, there are `r num_stations` distince stations, and `r num_ada` of them are ADA compliant, and `r proportion_entrance%` of station entrances / exits without vending allow entrance.
